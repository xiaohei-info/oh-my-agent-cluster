...
`oh-my-agent-cluster` 不是让一个 agent 更努力，而是在模型外部加一套工程控制系统：
...
```bash
git clone https://github.com/xiaohei-info/oh-my-agent-cluster.git
...
multica skill import \
  --url https://github.com/xiaohei-info/oh-my-agent-cluster/tree/main/skills/parallel-dev-orchestration \
  --on-conflict overwrite
multica skill import \
  --url https://github.com/xiaohei-info/oh-my-agent-cluster/blob/main/skills/parallel-dev-executor/SKILL.md
